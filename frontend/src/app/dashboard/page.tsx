...
export default function DashboardHome() {
 ...
 <span className="px-2 py-0.5 rounded bg-[#7c3aed]/10 text-[#7c3aed] font-mono text-[11px] border border-[#22d3ee]/20">
 ...
 className="px-3 py-1.5 rounded border border-white/30 hover:border-[#22d3ee] text-xs text-[#fafafa] hover:text-[#7c3aed] font-mono flex items-center gap-1.5 transition-all"
 >
 ...
 className="card bg-[#111] border border-white/30 hover:border-[#22d3ee] rounded-lg p-5 flex flex-col justify-between h-28 cursor-pointer transition-colors group"
 >
 <div className="flex items-center justify-between">
 <span className="text-sm text-[#666] group-hover:text-[#1a1a2e] transition-colors">Current capital</span>
 <Edit2 className="w-3.5 h-3.5 text-[#666] group-hover:text-[#7c3aed] transition-colors" />
 </div>
 <div>
 <h3 className="text-xl font-medium text-[#fafafa] group-hover:text-[#7c3aed] font-mono transition-colors">
 ₹{capital.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
 </h3>
 <span className="text-[10px] text-[#7c3aed] block mt-1">Click to customize capital balance</span>
 </div>
 </div>

 {/* Card: Today's PnL */}
 <div className="card bg-[#111] border border-white/30 rounded-lg p-5 flex flex-col justify-between h-28">
 <span className="text-sm text-[#666]">Today&apos;s PnL</span>
 <div>
 <h3 className={`text-xl font-medium font-mono ₹{isFreshMode ? 'text-[#1a1a2e]' : 'text-[#10b981]'}`}>
 ...
 <div>
 <h3 className={`text-xl font-medium font-mono ₹{isFreshMode ? 'text-[#1a1a2e]' : 'text-[#ef4444]'}`}>
 ...
 <div key={item.label} className="card bg-[#111] border border-white/30 rounded-lg p-4 flex flex-col justify-between h-20">
 ...
 <div className="card bg-[#111] border border-white/30 rounded-lg p-6">
 <div className="flex justify-between items-center mb-6">
 <h2 className="text-base font-medium text-[#fafafa]">
 Statistics
 </h2>
 {isFreshMode && (
 <span className="text-xs font-mono text-[#7c3aed]">Fresh Session Baseline</span>
 )}
 </div>
 ...
 <div key={stat.label} className="border-b border-white/30 pb-3">
 ...
 {/* Live Market panel */}
 <div className="card bg-[#111] border border-white/30 rounded-lg p-6 space-y-6">
 ...
 <span className="text-[#10b981] font-mono">+{g.change}%</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="bg-[#10b981]/10 border border-[#22c55e]/20 p-2 rounded text-[#10b981]">IT<br/>+1.45%</div>
 <div className="bg-[#10b981]/10 border border-[#22c55e]/20 p-2 rounded text-[#10b981]">BANK<br/>+0.82%</div>
 <div className="bg-[#ef4444]/10 border border-[#ef4444]/20 p-2 rounded text-[#ef4444]">PHARMA<br/>-0.65%</div>
 <div className="bg-[#10b981]/10 border border-[#22c55e]/20 p-2 rounded text-[#10b981]">METAL<br/>+0.22%</div>
 <div className="bg-[#ef4444]/10 border border-[#ef4444]/20 p-2 rounded text-[#ef4444]">AUTO<br/>-1.20%</div>
 <div className="border border-white/30 p-2 rounded text-[#666]">FIN<br/>0.00%</div>
 </div>
 </div>

 {/* Market Status and Option Chain KPI */}
 <div className="pt-4 border-t border-white/30 space-y-2.5 text-xs">
